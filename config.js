...
window.FMC_CONFIG = {
  ...
  /* Global admins: accounts whose email is listed here see the System area
   * (Theme Studio, Screen Layouts, …). Case-insensitive. */
  adminEmails: ["edgers-dives8r@icloud.com"]
};
